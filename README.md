# Training Log PWA v0.10.10

個人向けのPPLトレーニング記録PWAです。v0.10.10ではGoogle Drive API連携、種目管理のPPL表示フィルターに加え、上部ナビゲーションにホームボタンを追加しています。
...
- 分析画面の種目プルダウンを Push → Pull → Leg の順に整理。
- 各区分内は種目管理で設定した並び順を反映。
- 選択肢の先頭に【Push】【Pull】【Leg】を表示。
